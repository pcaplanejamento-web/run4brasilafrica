...
const contentSecurityPolicy = [
  ...
  "form-action 'self'",
  `script-src 'self' 'unsafe-inline'${devEval} https://www.googletagmanager.com https://static.cloudflareinsights.com https://www.youtube.com https://s.ytimg.com https://open.spotify.com https://strava-embeds.com`,
  "style-src 'self' 'unsafe-inline'",
  "img-src 'self' data: blob: https:",
  "font-src 'self' data:",
  "frame-src https://www.youtube.com https://www.youtube-nocookie.com https://open.spotify.com https://www.strava.com https://strava-embeds.com https://connect.garmin.com",

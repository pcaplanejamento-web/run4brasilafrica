  ...
  return (
    <>
      ...
      <SaveBar
        onSave={() =>
          save(
            { sejaParceiro: { title: title.trim(), subtitle: subtitle.trim() } },
...
export default function SejaParceiroPage() {
  ...
  return (
    <SejaParceiroPanel
      initialTitle={content.sejaParceiro?.title ?? ""}
      initialSubtitle={content.sejaParceiro?.subtitle ?? ""}
    />
  );
}

    ...
    <>
      ...
      <div className="flex max-w-[760px] flex-col gap-5">
        ...
        <Card>
              ...
              {([
                ...
                <div key={s.key}>
                  ...
                  >
                    ...
                    {/* A logo pode crescer bem mais (o certificado se adapta). */}
                    {s.key === "scaleLogo" && <option value="2">200%</option>}
                    {s.key === "scaleLogo" && <option value="2.5">250%</option>}
                    {s.key === "scaleLogo" && <option value="3">300%</option>}
                  </Select>
                </div>
              ))}
            </div>
          ...
          <div className="mt-3">
            <FieldLabel>Rodapé em negrito</FieldLabel>
            <div className="flex flex-wrap gap-2">
              {([
                { key: "domainBold", label: "Domínio" },
                { key: "issuedBold", label: "Data de emissão" },
                { key: "authBold", label: "Código de autenticação" },
              ] as { key: "domainBold" | "issuedBold" | "authBold"; label: string }[]).map((t) => {
                const on = cert[t.key] === true;
                return (
                  <button
                    key={t.key}
                    type="button"
            ...
            <p className="mt-1 text-[11px] text-adm-muted">No PDF, o domínio é clicável e abre o site.</p>
          </div>
        </Card>
